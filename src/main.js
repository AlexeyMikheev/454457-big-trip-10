...
const tripMainInfoContainer = tripMainContainer.querySelector(`.trip-main__trip-info`);
...
renderItem(tripMainControlsContainer, createFilterstemplate());

const mainContainer = document.querySelector(`.page-body__page-main`);
const tripMainEventsContainer = mainContainer.querySelector(`.trip-events`);

renderItem(tripMainEventsContainer, createSortTemplate());
renderItem(tripMainEventsContainer, createEditTemplate());
renderItem(tripMainEventsContainer, createItemsTemplate());
